...
if [ "$MMMV_USERSPACE_DISTRO_T1_BASHRC_PREFIX_LOAD_MODE_T1" != "mode_ok_to_load" ]; then
    ...
    echo "GUID=='5e1914e5-be69-4be1-953a-2272b01077e7'"
    echo ""
...
if [ "$MMMV_USERSPACE_DISTRO_T1_APPLIANCE_INSTANCE_SPECIFIC_MAIN_BASH_TIMESTAMP" == "$S_TIMESTAMP" ]; then
    ...
    if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" != "f" ]; then
        ...
        echo "GUID=='66c8af2a-c8ea-4644-b53a-2272b01077e7'"
        echo ""
    fi
else
...
if [ "$SB_OPERATINGSYSTEM_LINUX_ANDROID_TERMUX" == "t" ]; then
    ...
    #----------------------------------------------------------------------
        ...
        func_mmmv_userspace_distro_t1_declare_alias_cd_t1 \
            ...
            "79b44b42-e556-40bf-913a-2272b01077e7" \
...
if [ -e "$S_FP_0" ]; then
    ...
    if [ ! -d "$S_FP_0" ]; then
        ...
        func_mmmv_verify_that_the_file_exists_but_do_not_exit_t1 \
            "$S_FP_0" \
            "336f3421-e4af-4085-913a-2272b01077e7" \
    ...
    if [ -e "$S_FP_0" ]; then
        ...
        if [ ! -d "$S_FP_0" ]; then
            ...
            func_mmmv_verify_that_the_file_exists_but_do_not_exit_t1 \
                "$S_FP_0" \
                "4cde13a4-07eb-478c-bb3a-2272b01077e7" \
                "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT"
            # is here to conditionally display an error message.
        fi
        #----------------------------------------
        ...
        if [ "$SB_DISPLAY_VERIFICATION_FAILURE_MESSAGE_DEFAULT" == "t" ]; then
            if [ "$HOSTNAME" != "hoidla01" ]; then
                ...
                echo "GUID=='3f342a22-7135-4f20-923a-2272b01077e7'"
                echo ""
            fi
        fi
    fi
...
#--------------------------------------------------------------------------
# S_VERSION_OF_THIS_FILE="2760ea3c-4ebf-49af-813a-2272b01077e7"
#==========================================================================
