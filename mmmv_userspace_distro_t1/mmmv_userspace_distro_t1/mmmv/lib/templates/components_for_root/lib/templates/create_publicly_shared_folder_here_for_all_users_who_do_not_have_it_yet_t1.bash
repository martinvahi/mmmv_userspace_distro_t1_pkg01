...
#==========================================================================
# S_VERSION_OF_THIS_FILE="2b4ff1d7-a1b6-4994-b26a-336231e0b6e7"
S_FP_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"
S_FP_ORIG="`pwd`"
#--------------------------------------------------------------------------
# Configuration:
#--------------------------------------------------------------------------
S_FN_FOLDER_NAME_AT_S_FP_DIR="publicly_shared_folders"

echo ""
echo "Please comment out an exit clause that resides next to the "
echo "GUID=='2fb660d2-9eac-4446-856a-336231e0b6e7'"
echo ""
...
func_mmmv_exit_if_not_on_path_t2() { # S_COMMAND_NAME
    ...
    if [ "$S_LOCAL_VARIABLE" == "" ]; then
        ...
        echo "GUID=='23bcc72c-8845-443c-b36a-336231e0b6e7'"
        echo ""
        #----
        cd $S_FP_ORIG
        exit 1;
...
if [ "`whoami`" != "root" ]; then
    ...
    echo "GUID=='2870015b-17d5-4817-826a-336231e0b6e7'"
    echo ""
    #----
    cd $S_FP_ORIG
    exit 1;
...
func_mmmv_create_folders_if_missing_t1_helper_1() { # S_FN_HOME_FOLDER
    ...
    if [ ! -e $S_TMP_0 ]; then
        ...
        echo "    $S_TMP_0"
        echo "does not exist."
        echo "GUID=='c32bef1c-2dd7-490f-916a-336231e0b6e7'"
        echo ""
        #----
        cd $S_FP_ORIG
        exit 1;
    ...
    if [ ! -d $S_TMP_0 ]; then
        ...
        echo "GUID=='3d75b5d2-9b79-44b8-816a-336231e0b6e7'"
        echo ""
        #----
        cd $S_FP_ORIG
        exit 1;
    ...
    if [ "$S_FN_FOLDER_NAME_AT_S_FP_DIR" == "" ]; then
        ...
        echo "GUID=='2f712754-582c-496a-a16a-336231e0b6e7'"
        echo ""
        #----
        cd $S_FP_ORIG
        exit 1;
    ...
    if [ "$S_TMP_0" != "$S_FN_FOLDER_NAME_AT_S_FP_DIR" ]; then
        ...
        echo ""
        echo "GUID=='d8052c24-4926-4e3d-b26a-336231e0b6e7'"
        echo ""
        #----
        cd $S_FP_ORIG
        exit 1;
    ...
    if [ ! -e $S_TMP_0 ]; then
        ...
        if [ ! -e $S_TMP_0 ]; then
            ...
            echo "GUID=='5082ccaa-1ce9-4523-a46a-336231e0b6e7'"
            echo ""
            #----
            cd $S_FP_ORIG
            exit 1;
        ...
        if [ "`pwd`" != "$S_TMP_0" ]; then
            ...
            echo "GUID=='59592004-d50b-403a-b56a-336231e0b6e7'"
            #----
            cd $S_FP_ORIG
            exit 1;
        fi
        chown -f -R $S_FN_HOME_FOLDER $S_TMP_0
        chmod -f -R 0755 $S_TMP_0
        sync
    fi
    cd $S_FP_DIR
