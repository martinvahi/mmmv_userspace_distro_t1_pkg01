...
// Imported functions:
import { refocus, sendToReduceAndEcho } from "./Main.js";
/**
...
class ModalDialogue extends HTMLElement {
    constructor() {
        ...
        if (this.hasAttribute("specfnsHeader")) {
            const specfnsHeader = document.getElementById("special-functions-header").cloneNode(true)
                .content.children;
            this.prepend(...specfnsHeader);
        }
        // Wrap the template content around the content of this <modal-dialogue> element.
        const templateContent = document.getElementById("modal-dialogue-template")
...
export class Template extends TempFuncs {
     ...
     */
    getValueCheckNonEmpty(input, checkNonEmpty) {
...
export class Functions extends TempFuncs {
    ...
    constructor(functionsId) {
        ...
        const functions = this.dialogue.querySelectorAll("div.function-templates>div");
